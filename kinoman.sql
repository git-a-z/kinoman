...
INSERT INTO media (media_type_id, film_id, person_id, body, filename) VALUES
	...
	(1,9,NULL,'Атмосферный зимний вестерн от создателя «Криминального чтива» Квентина Тарантино. Охотник за головами Джон Рут после гражданской войны в США вынужден сопровождать заключённую. К ним прибавляются ещё один охотник и новый шериф, но конвой во время пути застигает снежная буря. Им приходится переждать непогоду в лавке, где уже была весьма колоритная четвёрка.',''),
	(1,10,NULL,'Ностальгическая картина, в которой главная роль досталась целой эпохе — эпохе шестидесятых. Актёр на закате карьеры Рик Далтон (Леонардо ДиКаприо) нервно пытается ухватиться за ускользающую славу. Единственная поддержка — его дублёр Клифф Бут (Брэд Питт), он же шофёр, ассистент и лучший друг Рика. Таким разным, на первый взгляд, им обоим важно не потеряться в этом слишком быстро меняющемся мире. Отсюда бесконечные съемки, скитания по Голливуду и воспоминания о былых днях. Сюжет вежливо уступит место остроумным отсылкам и бесконечным диалогам под музыку и пейзажи давно ушедших пленительных времён.',''),
	(2,1,NULL,NULL,'poster of "One Flew Over the Cuckoo`s Nest"'),
	(2,2,NULL,NULL,'poster of "The Shining"'),
	(2,3,NULL,NULL,'poster of "Escape from New York"'),
	(2,4,NULL,NULL,'poster of "The Thing"'),
	(2,5,NULL,NULL,'poster of "Big Trouble in Little China"'),
	(2,6,NULL,NULL,'poster of "Se7en"'),
	(2,7,NULL,NULL,'poster of "Fight Club"'),
	(2,8,NULL,NULL,'poster of "Pulp Fiction"'),
	(2,9,NULL,NULL,'poster of "The Hateful Eight"'),
	(2,10,NULL,NULL,'poster of "Once Upon a Time... in Hollywood"'),
	(2,NULL,1,NULL,'photo of Jack Nicholson'),
	(2,NULL,2,NULL,'photo of Milos Forman'),
	(2,NULL,3,NULL,'photo of Stanley Kubrick'),
	(2,NULL,4,NULL,'photo of Kurt Russell'),
	(2,NULL,5,NULL,'photo of John Carpenter'),
	(2,NULL,6,NULL,'photo of David Fincher'),
	(2,NULL,7,NULL,'photo of Brad Pitt'),
	(2,NULL,8,NULL,'photo of Quentin Tarantino'),
	(2,NULL,9,NULL,'photo of Samuel L. Jackson'),
	(2,NULL,10,NULL,'photo of Leonardo DiCaprio');
...
/*Представления*/
CREATE OR REPLACE
VIEW kinoman.films_info_view AS
SELECT 
...
GROUP BY fi.film_id;
/*SELECT * FROM films_info_view;*/

CREATE OR REPLACE
VIEW kinoman.persons_info_view AS
SELECT
	p.person_id,
